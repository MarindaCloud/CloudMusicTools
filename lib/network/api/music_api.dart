...
class MusicAPI{
  ...
  static sendNeteaseMusicAnalysis(String searchContent,String type) async{
    ...
    return await BaseProvider.sendRequestTypePost(RequestType.musicAnalysis, data: data,header: headers);
  }
  ...
  static sendSearchNeteaseMusic(String content) async{
    ...
    var response = await BaseProvider.sendRequestTypeGet(RequestType.netaseMusicSearch, data: data,header: headers);
